...
import com.aem.geeks.core.beans.ChatGPTRequest;
import com.aem.geeks.core.beans.ChatGptResponse;
...
@Component(immediate = true, service = Servlet.class, property = {
		...
		"sling.servlet.paths=" + "/bin/generative-ai/description",
...
public class GenerateDescriptionServlet extends SlingSafeMethodsServlet {
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		String text = "generate meta description for https://we-retail/us/en.html";
	...
	private String generateMessage(final String text) throws IOException {
		...
		//String responseVal = MAPPER.readValue(EntityUtils.toString(response.getEntity()), String.class);
		//ChatGptResponse chatGptResponse = new ChatGptResponse();
		//chatGptResponse.setChoices(resp);
